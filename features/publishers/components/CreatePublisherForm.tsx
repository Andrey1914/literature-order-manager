    ...
    <form onSubmit={handleSubmit} className="space-y-4 pt-2">
      ...
      <div className="space-y-1.5">
        ...
        <input
          ...
          className="w-full px-4 py-2.5 rounded-xl border border-gray-300 p-3 text-sm text-gray-900 placeholder:text-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 dark:bg-slate-950 dark:border-slate-800 dark:text-white dark:placeholder:text-slate-600 dark:focus:ring-indigo-500/20 transition-colors"
        />
      </div>
      <div className="space-y-1.5">
        <label
